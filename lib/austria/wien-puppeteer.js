...
const outputFileName = "wien.db";

// ** TRANSLATION AND FILTRATION WAS DONE THROUGH CHATGPT **
...
console.time("Puppeteer Wien Schools");
...
(async () => {
    ...
    for (let i = 0; i <= pageLimit; i++) {
        const url = `https://www.schulverzeichnis.eu/typ/?${i == 0 ? "" : `p=${i}&`}bundesland=wien`;
    ...
    for (let i = 481; i < hrefs.length; i++) {
    ...
    console.timeEnd("Puppeteer Wien Schools");
})();
*/