...
const outputFileName = "burgenland-schools.db";
...
console.time("Puppeteer Burgenland Schools");
...
(async () => {
    ...
    for (let i = 1; i <= pageLimit; i++) {
        const url = `https://www.schulverzeichnis.eu/typ/?${i == 1 ? "" : `p=${i}&`}bundesland=burgenland`;
    ...
    console.timeEnd("Puppeteer Burgenland Schools");
})();